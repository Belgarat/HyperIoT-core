...
export class AreasService {
    ...
    protected basePath = 'https://localhost/hyperiot/areas';
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findAllArea(delta?: number, page?: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public findAllArea(delta?: number, page?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public findAllArea(delta?: number, page?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public findAllArea(delta?: number, page?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findAllArea_1(observe?: 'body', reportProgress?: boolean): Observable<any>;
    public findAllArea_1(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public findAllArea_1(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public findAllArea_1(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
