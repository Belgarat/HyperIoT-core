...
export class DashboardwidgetsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public findAllDashboardWidget(delta?: number, page?: number, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public findAllDashboardWidget(delta?: number, page?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public findAllDashboardWidget(delta?: number, page?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public findAllDashboardWidget(delta?: number, page?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
