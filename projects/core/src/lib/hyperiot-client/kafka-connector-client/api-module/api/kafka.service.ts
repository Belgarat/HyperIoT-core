...
import { MqttConnectorConfig } from '../model/mqttConnectorConfig';
...
export class KafkaService {
    ...
    protected basePath = 'https://localhost/hyperiot/kafka';
    ...
    public add(body: MqttConnectorConfig, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/mqtt/connectors/add`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public update(instanceName: string, body: MqttConnectorConfig, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.basePath}/mqtt/connectors/${encodeURIComponent(String(instanceName))}/update`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
